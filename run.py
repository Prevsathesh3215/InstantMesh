...
parser.add_argument('--diffusion_steps', type=int, default=15, help='Denoising Sampling steps.')
parser.add_argument('--seed', type=int, default=5, help='Random seed for sampling.')
